...
int32_T ozysdriverandreceiver_d22bbe4d_49_ds_mcon_p(const NeDynamicSystem *sys,
  const NeDynamicSystemInput *t1, NeDsMethodOutput *out)
{
  static int32_T _cg_const_1[25] = { 0, 0, 0, 1, 2, 3, 4, 5, 6, 6, 6, 6, 6, 6, 6,
    6, 6, 6, 6, 6, 6, 6, 6, 6, 6 };

  static int32_T _cg_const_2[6] = { 6, 0, 1, 2, 5, 7 };

  (void)t1;
  out->mMCON_P.mNumCol = 24UL;
  out->mMCON_P.mNumRow = 24UL;
