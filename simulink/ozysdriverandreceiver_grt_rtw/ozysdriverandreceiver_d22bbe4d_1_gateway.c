...
#include "nesl_rtw.h"
#include "ozysdriverandreceiver_d22bbe4d_49.h"
#include "ozysdriverandreceiver_d22bbe4d_1_gateway.h"

void ozysdriverandreceiver_d22bbe4d_1_gateway(void)
{
  NeModelParameters modelparams = { (enum NeSolverTypeTag)0, 0.001, 0.001, 0.001,
    ...
    enum SscLoggingSettingTag)0, 660866723.0, TRUE, FALSE, FALSE };
  ...
  ozysdriverandreceiver_d22bbe4d_49_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("ozysdriverandreceiver/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
