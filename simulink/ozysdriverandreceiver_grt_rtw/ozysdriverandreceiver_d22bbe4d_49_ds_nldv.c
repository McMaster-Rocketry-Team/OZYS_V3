...
int32_T ozysdriverandreceiver_d22bbe4d_49_ds_nldv(const NeDynamicSystem *sys,
  const NeDynamicSystemInput *t1, NeDsMethodOutput *out)
{
  static boolean_T _cg_const_1[24] = { true, true, false, false, false, false,
  ...
  out->mNLDV.mX[17] = _cg_const_1[17];
  out->mNLDV.mX[18] = _cg_const_1[18];
  out->mNLDV.mX[19] = _cg_const_1[19];
  out->mNLDV.mX[20] = _cg_const_1[20];
  out->mNLDV.mX[21] = _cg_const_1[21];
  out->mNLDV.mX[22] = _cg_const_1[22];
  out->mNLDV.mX[23] = _cg_const_1[23];
  (void)sys;
  (void)out;
  return 0;
}
