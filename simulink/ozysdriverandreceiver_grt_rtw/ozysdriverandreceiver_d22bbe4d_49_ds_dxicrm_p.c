...
int32_T ozysdriverandreceiver_d22bbe4d_49_ds_dxicrm_p(const NeDynamicSystem *sys,
  const NeDynamicSystemInput *t1, NeDsMethodOutput *out)
{
  (void)t1;
  out->mDXICRM_P.mNumCol = 24UL;
  ...
  out->mDXICRM_P.mJc[18] = 0;
  out->mDXICRM_P.mJc[19] = 0;
  out->mDXICRM_P.mJc[20] = 0;
  out->mDXICRM_P.mJc[21] = 0;
  out->mDXICRM_P.mJc[22] = 0;
  out->mDXICRM_P.mJc[23] = 0;
  out->mDXICRM_P.mJc[24] = 0;
  (void)sys;
  (void)out;
  return 0;
}
